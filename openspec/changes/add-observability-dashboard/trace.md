...
updated_at: 2026-07-26 16:00:30
owner: product
sprint: sprint-012
impact:
  backend: true
...
cross_cutting_tags:
  - admin-list
prototype_refs:
  - issues/requirements/review/REQ-0076-observability-dashboard/prototype/web/observability-dashboard.html
  - issues/requirements/review/REQ-0076-observability-dashboard/prototype/web/observability-dashboard-context.md
png_checklist:
  required: false
...
| 类型 | 路径 |
|---|---|
| requirement | `issues/requirements/review/REQ-0076-observability-dashboard/requirement.md` |
| user-stories | `issues/requirements/review/REQ-0076-observability-dashboard/user-stories.md` |
| business-flow | `issues/requirements/review/REQ-0076-observability-dashboard/business-flow.md` |
| acceptance | `issues/requirements/review/REQ-0076-observability-dashboard/acceptance.md` |
| review | `issues/requirements/review/REQ-0076-observability-dashboard/review.md` |
| prototype | `issues/requirements/review/REQ-0076-observability-dashboard/prototype/web/observability-dashboard.html` |
...
| UI 策略 | 在 `/admin/logs` 增加链路观测面板，复用 `MetricCardGrid`、筛选联动、日志详情抽屉、fixed toast 和管理端暗色 token。 |
