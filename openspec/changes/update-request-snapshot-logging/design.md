...
该变更涉及后端请求日志 middleware、日志服务、日志仓储、SQLite/MySQL schema、Pydantic Schema、管理端日志详情 API、Web 管理端日志详情抽屉、OpenAPI / Orval 与测试治理。REQ 提供了低保真 HTML 原型：`issues/requirements/review/REQ-0071-request-snapshot-logging/prototype/web/request-snapshot-log-detail.html`。
