...
- [x] 更新 `.agents/skills/{req,bug,opsx,sprint,build}-*`、`.agents/skills/capture`、`.agents/skills/initialize-project`，统一引用上下文预算规则并保留命令特定边界。
- [x] 新增 `scripts/validate-agent-context-budget.py`，校验 命令技能是否遵守预算入口。
