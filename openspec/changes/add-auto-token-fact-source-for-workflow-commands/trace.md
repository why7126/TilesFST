...
| 类型 | ID | 路径 |
|---|---|---|
| REQ | REQ-0037-auto-token-fact-source-for-workflow-commands | `issues/requirements/review/REQ-0037-auto-token-fact-source-for-workflow-commands/` |
| Parent REQ | REQ-0034-ai-token-usage-observability | `issues/requirements/archive/REQ-0034-ai-token-usage-observability/` |
| Related REQ | REQ-0035-ai-usage-snapshot-sprint-close-exps | `issues/requirements/review/REQ-0035-ai-usage-snapshot-sprint-close-exps/` |
...
| `python scripts/validate-agent-context-budget.py` | Validate source-command context budget guardrails | passed |
