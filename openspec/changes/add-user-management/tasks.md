...
- [ ] 8.2 `./scripts/docker-up.sh` 验证 `/admin/users`（admin 登录）

## 9. 视觉验收（PNG Golden Reference Gate）

- [ ] 9.1 1280×1024 并排 `/admin/users` 与 `user-management-list.png`
- [ ] 9.2 打开添加用户弹窗并排 `user-management-modal.png`
...
- [ ] 11.1 本文件全部 `[x]` 后执行 `/opsx-archive add-user-management`
