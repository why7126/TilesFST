...
Banner 管理视觉对齐 MUST 通过 PNG golden reference 验收 gate。
...
#### Scenario: 四套弹窗 PNG 并排验收

- **WHEN** 团队分别并排对比四套 modal 实现与 `banner-management-modal-{type}.png`
- **THEN** 640px 弹窗、条件字段显隐、无状态块 MUST pass
