...
| 类型 | 路径 | 说明 |
|---|---|---|
| REQ | `issues/requirements/review/REQ-0075-audit-log-task-trace-linking/requirement.md` | PRD |
| Acceptance | `issues/requirements/review/REQ-0075-audit-log-task-trace-linking/acceptance.md` | 功能 AC 与横切 AC |
| Prototype Context | `issues/requirements/review/REQ-0075-audit-log-task-trace-linking/prototype/web/context.md` | 日志审计 Task Trace 展示策略 |
| Prototype HTML | `issues/requirements/review/REQ-0075-audit-log-task-trace-linking/prototype/web/audit-log-task-trace.html` | 低保真 HTML 草图 |
