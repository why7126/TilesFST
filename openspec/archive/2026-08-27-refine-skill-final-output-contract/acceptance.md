...
evidence:
  ...
  - python scripts/validate-doc-prose-hygiene.py AGENTS.md rules/agent-context-budget.md docs/README.md docs/spec-logs/CHANGELOG.md openspec/archive/2026-08-27-refine-skill-final-output-contract/*.md openspec/archive/2026-08-27-refine-skill-final-output-contract/specs/agent-workflow-tooling/spec.md
failed_items: []
