...
- 归档路径与时间证据：Change 已归档至 `openspec/archive/2026-07-23-fix-miniapp-sku-video-slow-start/`；BUG trace 记录 `/opsx-archive fix-miniapp-sku-video-slow-start` 于 `2026-07-23 23:12:44` 完成状态同步，并于 `2026-07-23 23:13:16` 执行 `review -> archive` lifecycle-stage-migrate。
