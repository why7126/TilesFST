...
Web 客户端 MUST 提供管理端登录页，路由为 `/admin/login`，视觉风格 MUST 高保真对齐 `issues/requirements/archive/REQ-0001-user-login/prototype/web/user-login.png` 暗色工业风设计；桌面端并排对比时，布局、背景材质摄影、色彩、间距与控件样式 MUST 与原型一致。
...
- **AND** 验收 MUST 记录在 `iterations/archive/sprint-001/acceptance-report.md`
