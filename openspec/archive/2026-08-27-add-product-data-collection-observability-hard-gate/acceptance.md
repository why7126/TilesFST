...
updated_at: 2026-08-27 23:12:22
---
...
product_data_collection_observability:
  ...
  validation: 已运行采集规范门禁聚焦校验、OpenSpec strict 校验、语言校验、相关自动化测试、Sprint scope 校验和归档前 complete 状态检查；Workflow Sync 已在 apply 阶段回填 applied，archive 阶段将最终迁移到归档态。
```
...
```yaml
acceptance_status: passed
accepted_at: 2026-08-27 23:12:22
accepted_by: opsx-archive
evidence:
  - scripts/validate-product-data-observability-gates.py
  - tests/test_validate_product_data_observability_gates.py
  - openspec/archive/2026-08-27-add-product-data-collection-observability-hard-gate/tasks.md
failed_items: []
notes: /opsx-archive 归档前复核通过；本 Change 不直接修改业务 API、DB、Web、小程序或 App 代码，Orval 与 Docker Compose 为 N/A。
```
