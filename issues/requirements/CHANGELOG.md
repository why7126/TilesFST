---
purpose: 需求当前态看板索引
content: 每个 REQ 一行的当前状态、阶段、Sprint、Change、下一步和事实源路径摘要
...
updated_at: 2026-08-26 10:48:56
---
...
|---|---|---|---|---|---|---|---|---|
| REQ-0126-product-data-collection-observability-standard | 建立通用产品数据采集与链路观测规范 | in_sprint | review | sprint-026 | add-product-data-collection-observability-standard | 2026-08-26 11:02:04 | `/opsx-archive REQ-0126-product-data-collection-observability-standard` | `issues/requirements/review/REQ-0126-product-data-collection-observability-standard/trace.md` |
| REQ-0125-miniapp-certificate-detail-home-floating-button | 小程序证书详情页新增返回首页悬浮按钮 | in_sprint | review | sprint-026 | update-miniapp-certificate-detail-home-floating-button | 2026-08-25 22:58:02 | `/opsx-apply REQ-0125-miniapp-certificate-detail-home-floating-button` | `issues/requirements/review/REQ-0125-miniapp-certificate-detail-home-floating-button/trace.md` |
| REQ-0124-log-audit-behavior-trace-model | 日志审计补齐行为链路与任务链路采集模型 | in_sprint | review | sprint-026 | add-log-audit-behavior-trace-model | 2026-08-25 22:58:00 | `/opsx-apply REQ-0124-log-audit-behavior-trace-model` | `issues/requirements/review/REQ-0124-log-audit-behavior-trace-model/trace.md` |
| REQ-0123-upload-stage-trace-spans | 上传链路阶段级耗时写入 trace spans | in_sprint | review | sprint-026 | null | 2026-08-25 18:53:00 | `/req-opsx REQ-0123-upload-stage-trace-spans` | `issues/requirements/review/REQ-0123-upload-stage-trace-spans/trace.md` |
