# REQ-0017 系统设置页面 v2 - 基础信息原型上下文工程

## 1. 原型目标

本文件用于指导 Cursor / AI 前端开发还原 TILESFST 管理后台系统设置「基础信息」页面。

开发优先级：
1. `prototype/web/system-settings-basic.html`
2. `prototype/web/system-settings-basic.png`
3. `requirement.md`
