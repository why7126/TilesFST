...
updated_at: 2026-07-26 16:57:18
lifecycle:
...
| 类型 | 路径 | 说明 |
|---|---|---|
| capture | `issues/requirements/archive/REQ-0074-task-trace-coverage-expansion/capture.md` | 原始需求记录 |
| requirement | `issues/requirements/archive/REQ-0074-task-trace-coverage-expansion/requirement.md` | PRD |
| user-stories | `issues/requirements/archive/REQ-0074-task-trace-coverage-expansion/user-stories.md` | 用户故事 |
...
| prototype | `issues/requirements/archive/REQ-0074-task-trace-coverage-expansion/prototype/web/task-trace-feedback.html` | 复杂任务追踪标识反馈 HTML 原型 |
| prototype-context | `issues/requirements/archive/REQ-0074-task-trace-coverage-expansion/prototype/web/task-trace-feedback-context.md` | 原型说明 |
| review | `issues/requirements/archive/REQ-0074-task-trace-coverage-expansion/review.md` | 评审结论 |
...
| 时间 | 命令 | 说明 |
|---|---|---|
| 2026-07-26 16:56:08 | lifecycle-stage-migrate | review → archive（/opsx-archive update-task-trace-coverage-expansion） |
| 2026-07-26 16:55:33 | /opsx-archive | Change `update-task-trace-coverage-expansion` 已归档，状态同步完成。 |
| 2026-07-26 16:55:33 | workflow-sync | 状态同步为 done（Change archived）。 |
