...
updated_at: 2026-07-26 16:53:07
lifecycle:
...
| 类型 | 路径 | 说明 |
|---|---|---|
| capture | `issues/requirements/archive/REQ-0071-request-snapshot-logging/capture.md` | 原始需求记录 |
| requirement | `issues/requirements/archive/REQ-0071-request-snapshot-logging/requirement.md` | PRD |
| user-stories | `issues/requirements/archive/REQ-0071-request-snapshot-logging/user-stories.md` | 用户故事 |
| business-flow | `issues/requirements/archive/REQ-0071-request-snapshot-logging/business-flow.md` | 业务流程 |
| acceptance | `issues/requirements/archive/REQ-0071-request-snapshot-logging/acceptance.md` | 验收标准 |
| review | `issues/requirements/archive/REQ-0071-request-snapshot-logging/review.md` | 需求评审记录 |
| prototype | `issues/requirements/archive/REQ-0071-request-snapshot-logging/prototype/web/request-snapshot-log-detail.html` | 管理端日志详情低保真原型 |
...
| 时间 | 命令 | 说明 |
|---|---|---|
| 2026-07-26 16:52:16 | lifecycle-stage-migrate | review → archive（/opsx-archive update-request-snapshot-logging） |
| 2026-07-26 16:51:38 | /opsx-archive | Change `update-request-snapshot-logging` 已归档，状态同步完成。 |
