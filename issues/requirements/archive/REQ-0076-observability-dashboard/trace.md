...
updated_at: 2026-07-26 17:08:40
lifecycle:
...
| 类型 | 路径 | 说明 |
|---|---|---|
| capture | `issues/requirements/archive/REQ-0076-observability-dashboard/capture.md` | 原始需求记录 |
| requirement | `issues/requirements/archive/REQ-0076-observability-dashboard/requirement.md` | 需求 PRD 草稿 |
| user-stories | `issues/requirements/archive/REQ-0076-observability-dashboard/user-stories.md` | 用户故事与验收要点 |
| business-flow | `issues/requirements/archive/REQ-0076-observability-dashboard/business-flow.md` | 排障与追踪业务流程 |
| acceptance | `issues/requirements/archive/REQ-0076-observability-dashboard/acceptance.md` | 功能 AC 与横切 AC |
| review | `issues/requirements/archive/REQ-0076-observability-dashboard/review.md` | 需求评审结论 |
| prototype | `issues/requirements/archive/REQ-0076-observability-dashboard/prototype/web/observability-dashboard.html` | 管理端链路观测仪表原型策略 |
...
| 时间 | 命令 | 说明 |
|---|---|---|
| 2026-07-26 16:58:50 | lifecycle-stage-migrate | review → archive（/opsx-archive add-observability-dashboard） |
| 2026-07-26 16:58:06 | /opsx-archive | Change `add-observability-dashboard` 已归档，状态同步完成。 |
...
- 2026-07-26 16:58:06 workflow-sync：状态同步为 done（Change archived）
