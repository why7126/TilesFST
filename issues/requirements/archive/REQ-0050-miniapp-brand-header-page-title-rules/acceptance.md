...
- [x] AC-LAYOUT-005 320、375、430 pt 宽度下，返回按钮、标题和右侧胶囊避让区无重叠。
...
- [x] AC-TEST-006 后续实现阶段必须记录或截图 320、375、430 pt 宽度下导航栏无重叠、内容不遮挡。
...
| 时间 | 来源 | 结论 |
|---|---|---|
| 2026-07-19 20:47:02 | 用户确认，微信开发者工具 | 320、375、430 pt 宽度下，首页双行文案、非首页单行标题、返回按钮、右侧微信原生胶囊避让区和页面内容避让验收通过。 |
