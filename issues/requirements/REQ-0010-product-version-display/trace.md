...
openspec_changes:
  - change_id: add-product-version-display
    ...
    status: archived
documents:
  capture: issues/requirements/REQ-0010-product-version-display/capture.md
  requirement: issues/requirements/REQ-0010-product-version-display/requirement.md
  user_stories: issues/requirements/REQ-0010-product-version-display/user-stories.md
  business_flow: issues/requirements/REQ-0010-product-version-display/business-flow.md
  acceptance: issues/requirements/REQ-0010-product-version-display/acceptance.md
  review: issues/requirements/REQ-0010-product-version-display/review.md
  prototype:
