...
| 技能与规则约束 | 更新相关 source-command 技能或流程规则，使 snapshot 成为默认步骤。 |
...
相关 source-command 技能 MUST 把 AI usage snapshot 生成或校验列入默认流程。
...
| 相关技能 | `.agents/skills/source-command-sprint-archive/SKILL.md` | 后续需要纳入默认步骤。 |
| 相关技能 | `.agents/skills/source-command-sprint-exps/SKILL.md` | 后续需要禁止静默 estimated fallback。 |
