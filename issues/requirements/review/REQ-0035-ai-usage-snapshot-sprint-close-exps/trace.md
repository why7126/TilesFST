...
| 类型 | 路径 | 说明 |
|---|---|---|
| capture | `issues/requirements/review/REQ-0035-ai-usage-snapshot-sprint-close-exps/capture.md` | 原始需求记录 |
| requirement | `issues/requirements/review/REQ-0035-ai-usage-snapshot-sprint-close-exps/requirement.md` | PRD |
| user-stories | `issues/requirements/review/REQ-0035-ai-usage-snapshot-sprint-close-exps/user-stories.md` | 用户故事 |
| business-flow | `issues/requirements/review/REQ-0035-ai-usage-snapshot-sprint-close-exps/business-flow.md` | 业务流程 |
| acceptance | `issues/requirements/review/REQ-0035-ai-usage-snapshot-sprint-close-exps/acceptance.md` | 验收标准 |
| review | `issues/requirements/review/REQ-0035-ai-usage-snapshot-sprint-close-exps/review.md` | 评审结论 |
