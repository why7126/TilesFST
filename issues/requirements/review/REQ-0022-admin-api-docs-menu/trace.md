...
updated_at: 2026-07-01 09:26:23
knowledge_base_refs:
...
|---|---|---|---|---|
| BUG-0051-api-docs-swagger-ui-link-wrong | high | draft | — | 接口文档页 Swagger UI 入口跳转到 Web 首页 |
| BUG-0052-api-docs-metric-cards-inconsistent | medium | draft | — | 接口文档页指标卡样式与瓷砖 SKU 页不一致 |
| BUG-0053-api-docs-list-layout-pagination-inconsistent | medium | draft | — | 接口文档列表冗余系统接口信息且分页未与 SKU 页一致 |
