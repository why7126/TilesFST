...
updated_at: 2026-07-12 09:52:06
recorded_by: product
source: 用户输入
priority_hint: P1
...
- 预期后续：需要明确自动构建触发点、本地 session 输入来源、失败降级策略、安全脱敏边界与对每个 source-command skill 的改造范围。
...
- [ ] 是否需要更新 `rules/agent-context-budget.md`、`data/ai-usage/README.md` 和所有 source-command skill 的 Final Step。
