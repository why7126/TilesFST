...
| 类型 | 路径 | 说明 |
|---|---|---|
| capture | `issues/requirements/review/REQ-0073-task-trace-parent-request-model/capture.md` | 原始需求记录 |
| requirement | `issues/requirements/review/REQ-0073-task-trace-parent-request-model/requirement.md` | PRD 草稿 |
| user-stories | `issues/requirements/review/REQ-0073-task-trace-parent-request-model/user-stories.md` | 用户故事 |
| business-flow | `issues/requirements/review/REQ-0073-task-trace-parent-request-model/business-flow.md` | 业务流程 |
| acceptance | `issues/requirements/review/REQ-0073-task-trace-parent-request-model/acceptance.md` | 验收标准 |
| prototype-context | `issues/requirements/review/REQ-0073-task-trace-parent-request-model/prototype/web/context.md` | Web 原型策略 |
| review | `issues/requirements/review/REQ-0073-task-trace-parent-request-model/review.md` | 评审结论 |
| openspec-change | `openspec/changes/fix-task-trace-parent-request-model/` | OpenSpec Change |
