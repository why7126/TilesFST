...
updated_at: 2026-07-01 09:26:32
---
...
status: draft
readiness: Not Ready
next_step: /req-complete REQ-0023-api-docs-swagger-detail-link
...
- `/req-complete` 阶段补齐 user-stories、business-flow、acceptance、trace；确认是否需要轻量 prototype 或直接复用 REQ-0022 页面原型。
