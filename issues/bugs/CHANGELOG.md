...
| BUG-0141-ai-usage-token-count-jsonl | AI usage extractor 未识别新版 token_count JSONL 导致 Sprint snapshot 缺失 | done | archive | sprint-026 | fix-ai-usage-message-content-token-count | 2026-08-27 23:14:31 | 暂无可推进下一步 | `issues/bugs/archive/BUG-0141-ai-usage-token-count-jsonl/trace.md` |
