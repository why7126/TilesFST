...
6. 对照 `issues/requirements/archive/REQ-0006-tile-sku-management/acceptance.md` AC-024、AC-026。
...
- 暂无截图。
- 当前需求：`issues/requirements/archive/REQ-0006-tile-sku-management/requirement.md` §字段定义
