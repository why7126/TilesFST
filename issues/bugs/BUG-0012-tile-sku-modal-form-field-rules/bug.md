...
8. 对照 `issues/requirements/REQ-0006-tile-sku-management/acceptance.md` AC-024、AC-026、AC-015。
...
| 需求字段定义 | `issues/requirements/REQ-0006-tile-sku-management/requirement.md` |
