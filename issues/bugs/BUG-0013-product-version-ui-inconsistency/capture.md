...
4. 并排对照：
   ...
   - `issues/requirements/REQ-0010-product-version-display/acceptance.md`（AC-006、AC-013、AC-015）
...
- 原型：`issues/requirements/REQ-0010-product-version-display/prototype/web/product-version-sidebar-admin.html`
