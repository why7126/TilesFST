...
- 已补充 DevTools Network 截图：`issues/bugs/review/BUG-0143-miniapp-telemetry-request-amplification/screenshots/20260826080932-devtools-network-home-startup.png`。
- 已补充 `event` 过滤截图：`issues/bugs/review/BUG-0143-miniapp-telemetry-request-amplification/screenshots/20260826081200-devtools-network-event-filter.png`。
