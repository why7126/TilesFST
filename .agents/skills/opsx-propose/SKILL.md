...
Use this skill when the user asks to run the workflow command `opsx-propose`.
...
```bash
python scripts/extract-ai-usage.py --post-command-hook --workflow-event opsx.propose --change <change-id> --json
```
