...
updated_at: 2026-07-08 09:26:36
note: 所有 source-command 技能与普通开发任务均应遵守，优先级高于单个技能中的宽泛读取建议
---
...
`.agents/skills/source-command-*` 技能 MUST：
...
该脚本用于检查 source-command 技能是否引用本规则，并阻止常见宽泛读取模式回退。
