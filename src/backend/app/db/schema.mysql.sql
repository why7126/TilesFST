...
CREATE TABLE IF NOT EXISTS request_logs (
  ...
  behavior_trace_id VARCHAR(128),
  parent_behavior_event_id VARCHAR(128),
  ...
  INDEX idx_request_logs_behavior_trace (behavior_trace_id, created_at),
  INDEX idx_request_logs_parent_behavior_event (parent_behavior_event_id, created_at),
...
CREATE TABLE IF NOT EXISTS usage_events (
  ...
  INDEX idx_usage_events_behavior_trace (behavior_trace_id, created_at),
  INDEX idx_usage_events_behavior_event (behavior_event_id),
...
CREATE TABLE IF NOT EXISTS task_traces (
  ...
  INDEX idx_task_traces_behavior_trace (behavior_trace_id, created_at),
