...
export interface ApiResponsePerformanceFilterOptionsData {
  code?: number;
  message?: string;
  data?: PerformanceFilterOptionsData | null;
}
...
export type ListPerformanceFilterOptionsApiV1AdminPerformanceEventsFilterOptionsGetParams = {
start_time?: string | null;
end_time?: string | null;
};
 ...
 */
const getAdminDashboardSummaryApiV1AdminDashboardSummaryGet = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<ApiResponseAdminDashboardSummary>> => {
    return axiosInstance.get(
      `/api/v1/admin/dashboard/summary`,options
    );
  }
...
/**
 * 系统管理员按时间范围查询 RUM 筛选维度候选值；候选值不随其他筛选项级联收敛。
 * @summary 真实用户页面性能筛选候选值
 */
const listPerformanceFilterOptionsApiV1AdminPerformanceEventsFilterOptionsGet = (
    params?: ListPerformanceFilterOptionsApiV1AdminPerformanceEventsFilterOptionsGetParams, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<ApiResponsePerformanceFilterOptionsData>> => {
    return axiosInstance.get(
...
export type ListPerformanceFilterOptionsApiV1AdminPerformanceEventsFilterOptionsGetResult = AxiosResponse<ApiResponsePerformanceFilterOptionsData>
