Component({
  data: {
    ...
    list: [
      ...
      {
        pagePath: '/pages/brand-list/index',
        text: '品牌',
        iconPath: '/assets/tabbar/brand-default.png',
        selectedIconPath: '/assets/tabbar/brand-active.png',
      },
      {
        pagePath: '/pages/certificates/index',
        text: '证书',
        iconPath: '/assets/tabbar/certificate-default.png',
        selectedIconPath: '/assets/tabbar/certificate-active.png',
      },
      {
        pagePath: '/pages/favorites/index',
        text: '收藏',
        iconPath: '/assets/tabbar/favorite-default.png',
