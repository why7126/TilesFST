---
note: workflow-sync — 0/6 Change 已 archive；5 applied；待人工 sign-off
...
| 类型 | ID | Change | 状态 |
|---|---|---|---|
| REQ | REQ-0071-request-snapshot-logging | update-request-snapshot-logging | planned |
| REQ | REQ-0072-client-request-identity-standard | standardize-client-request-identity | applied |
| REQ | REQ-0073-task-trace-parent-request-model | fix-task-trace-parent-request-model | planned |
| REQ | REQ-0074-task-trace-coverage-expansion | update-task-trace-coverage-expansion | planned |
| REQ | REQ-0075-audit-log-task-trace-linking | link-audit-logs-to-task-trace | planned |
| REQ | REQ-0076-observability-dashboard | add-observability-dashboard | planned |
...
REQ-0072 已完成本地实现、契约/文档同步、OpenAPI/Orval 生成和聚焦自动化验证，当前状态 applied，待 `/opsx-archive standardize-client-request-identity`。REQ-0071、REQ-0073、REQ-0074、REQ-0075 与 REQ-0076 仍按各自 Change 状态继续实现或验收。
