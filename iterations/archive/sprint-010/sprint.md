...
| Change | `openspec/archive/2026-07-22-update-password-validation-policy/` |
| Change | `openspec/archive/2026-07-22-add-miniapp-wechat-share-pages/` |
| Change | `openspec/archive/2026-07-22-fix-miniapp-sku-detail-duplicate-brand-button/` |
| Change | `openspec/archive/2026-07-22-fix-login-page-tool-selector-alignment/` |
| Change | `openspec/archive/2026-07-22-fix-miniapp-usage-events-contract-drift/` |
| Change | `openspec/archive/2026-07-22-fix-upload-size-limit-consistency/` |
| Change | `openspec/archive/2026-07-22-fix-theme-preference-sync-toast-persistent/` |
| Change | `openspec/archive/2026-07-22-fix-miniapp-sku-detail-brand-card-route/` |
| Change | `openspec/archive/2026-07-22-fix-miniapp-category-secondary-name-truncated/` |
| Change | `openspec/archive/2026-07-22-fix-prod-admin-brand-banner-save/` |
| Change | `openspec/archive/2026-07-22-refine-sku-metadata-name-code-display/` |
| Change | `openspec/archive/2026-07-22-fix-admin-dashboard-overview-real-data/` |
| Change | `openspec/archive/2026-07-22-fix-admin-banner-image-preview-cropped/` |
